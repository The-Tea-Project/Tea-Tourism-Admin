...
function Transport() {
  ...
  useEffect(() => {
    axios.get(`https://theteaprojadminbackend.vercel.app/api/transports`)
  ...
  const handleSubmit = async e => {
    ...
    await axios.post(`https://theteaprojadminbackend.vercel.app/api/transports`, payload);
    setShowForm(false);
    setForm({
  ...
  const handleDelete = async (id) => {
    await axios.delete(`https://theteaprojadminbackend.vercel.app/api/transports/${id}`);
